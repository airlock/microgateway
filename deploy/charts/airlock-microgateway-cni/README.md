...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/4.5.6).__
...
| image.digest | string | `"sha256:6de0fcca3633dda81451ac485abedb7f38dd8b07c0de9bffeedd0b53cfbd6554"` | SHA256 image digest to pull (in the format "sha256:7144f7bab3d4c2648d7e59409f15ec52a18006a128c733fcff20d3a4a54ba44a"). Overrides tag when specified. |
...
| image.tag | string | `"4.5.6"` | Image tag to pull. |
