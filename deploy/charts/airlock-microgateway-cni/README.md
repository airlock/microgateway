...
![Version: 4.2.11](https://img.shields.io/badge/Version-4.2.11-informational?style=flat-square) ![AppVersion: 4.2.11](https://img.shields.io/badge/AppVersion-4.2.11-informational?style=flat-square)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/4.2.11).__
...
| image.digest | string | `"sha256:a180704f2de82d657bcee862760776365aafd900eea185e2150fe924cf44d3d3"` | SHA256 image digest to pull (in the format "sha256:7144f7bab3d4c2648d7e59409f15ec52a18006a128c733fcff20d3a4a54ba44a"). Overrides tag when specified. |
...
| image.tag | string | `"4.2.11"` | Image tag to pull. |
