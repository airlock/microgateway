...
![Version: 4.2.10](https://img.shields.io/badge/Version-4.2.10-informational?style=flat-square) ![AppVersion: 4.2.10](https://img.shields.io/badge/AppVersion-4.2.10-informational?style=flat-square)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/4.2.10).__
...
| image.digest | string | `"sha256:a971da0aca136454a372b124a357072e384cc0cb437ee28d4f237e9548438962"` | SHA256 image digest to pull (in the format "sha256:7144f7bab3d4c2648d7e59409f15ec52a18006a128c733fcff20d3a4a54ba44a"). Overrides tag when specified. |
...
| image.tag | string | `"4.2.10"` | Image tag to pull. |
