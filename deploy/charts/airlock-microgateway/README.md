...
1. Install CRDs and Operator.
   ...
   helm install airlock-microgateway -n airlock-microgateway-system oci://quay.io/airlockcharts/microgateway --version '4.3.9' --wait
   ```

2. (Recommended) You can verify the correctness of the installation with `helm test`.
   ```bash
   helm upgrade airlock-microgateway -n airlock-microgateway-system --set tests.enabled=true --reuse-values oci://quay.io/airlockcharts/microgateway --version '4.3.9'
   helm test airlock-microgateway -n airlock-microgateway-system --logs
   helm upgrade airlock-microgateway -n airlock-microgateway-system --set tests.enabled=false --reuse-values oci://quay.io/airlockcharts/microgateway --version '4.3.9'
   ```
...
```bash
kubectl apply -k https://github.com/airlock/microgateway/deploy/charts/airlock-microgateway/crds/?ref=4.3.9 --server-side --force-conflicts
```
...
| engine.image.digest | string | `"sha256:7685da23f659e1c647116a3c7a65bd0902fbc5c85d53f3a268f02c0048ff243f"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| engine.image.tag | string | `"4.3.9"` | Image tag to pull. |
...
| operator.image.digest | string | `"sha256:e77ba4ec1cd9467c184c44223d7f1b84802a10af4dc11ec2a40b2f6554b6b915"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| operator.image.tag | string | `"4.3.9"` | Image tag to pull. |
...
| sessionAgent.image.digest | string | `"sha256:9df43fa3b3fb5354387a3dd4c92c276efff50e27a3328642e923cf85e77fb3a5"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| sessionAgent.image.tag | string | `"4.3.9"` | Image tag to pull. |
