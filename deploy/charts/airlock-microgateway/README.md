...
[![Release](https://img.shields.io/badge/Release-v5.1.0--alpha1-6bba62)](https://github.com/airlock/microgateway/releases/tag/5.1.0-alpha1)
[![Gateway API Conformance](https://img.shields.io/badge/Gateway%20API%20Conformance-v1.6.0--rc.1-6bba62?logo=kubernetes&logoColor=white)](https://github.com/kubernetes-sigs/gateway-api/blob/main/conformance/reports/v1.6.0-rc.1/airlock-microgateway)
[![GitHub](https://img.shields.io/badge/GitHub-Published-6bba62?logo=github&logoColor=white)](https://github.com/airlock/microgateway/releases/tag/5.1.0-alpha1)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/5.1.0-alpha1).__
...
```console
kubectl apply --server-side -f https://github.com/kubernetes-sigs/gateway-api/releases/download/v1.6.0-rc.1/standard-install.yaml
```
...
| config.engineImage.digest | string | `"sha256:61c5ba8bb5f5a3a5f11685bd0a58a0b466529a87dbd037ea2c2f6805b7c146ca"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.engineImage.tag | string | `"5.1.0-alpha1"` | Image tag to pull. |
...
| config.sessionAgentImage.digest | string | `"sha256:cacfb9bfecd3ee57552df1cb77aec6e3dd00a82c4d0544e148e0eb5692e4ed03"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.sessionAgentImage.tag | string | `"5.1.0-alpha1"` | Image tag to pull. |
...
| image.digest | string | `"sha256:b9a55a21bc4eefeebe519a36d1b37aeba7d097a22f70a346784614cb4827df45"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| image.tag | string | `"5.1.0-alpha1"` | Image tag to pull. |
