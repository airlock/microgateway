...
![Version: 4.2.0](https://img.shields.io/badge/Version-4.2.0-informational?style=flat-square) ![AppVersion: 4.2.0](https://img.shields.io/badge/AppVersion-4.2.0-informational?style=flat-square)
...
__This Helm chart is part of Airlock Microgateway. See [our GitHub repo](https://github.com/airlock/microgateway/tree/4.2.0).__
...
| engine.image.digest | string | `"sha256:16215470a3d989681db78078a89edc01ecf5d7dd38822804b98ae4b677ce0f8a"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| engine.image.tag | string | `"4.2.0"` | Image tag to pull. |
...
| networkValidator.image.digest | string | `"sha256:35bec721169105c2f254d3a49e366a56eb912bfb8979b445ad955f3d38c857a1"` | SHA256 image digest to pull (in the format "sha256:35bec721169105c2f254d3a49e366a56eb912bfb8979b445ad955f3d38c857a1"). Overrides tag when specified. |
...
| operator.image.digest | string | `"sha256:bc32ccaf517fdf51f9ec6493d1a3f224e15da26e11717c51eab7f7f6f28a1bd2"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| operator.image.tag | string | `"4.2.0"` | Image tag to pull. |
