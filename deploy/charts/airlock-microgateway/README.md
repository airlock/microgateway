...
![Version: 4.4.7](https://img.shields.io/badge/Version-4.4.7-informational?style=flat-square) ![AppVersion: 4.4.7](https://img.shields.io/badge/AppVersion-4.4.7-informational?style=flat-square)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/4.4.7).__
...
1. Install CRDs and Operator.
   ...
   helm install airlock-microgateway -n airlock-microgateway-system oci://quay.io/airlockcharts/microgateway --version '4.4.7' --wait
   ```

2. (Recommended) You can verify the correctness of the installation with `helm test`.
   ```bash
   helm upgrade airlock-microgateway -n airlock-microgateway-system --set tests.enabled=true --reuse-values oci://quay.io/airlockcharts/microgateway --version '4.4.7'
   helm test airlock-microgateway -n airlock-microgateway-system --logs
   helm upgrade airlock-microgateway -n airlock-microgateway-system --set tests.enabled=false --reuse-values oci://quay.io/airlockcharts/microgateway --version '4.4.7'
   ```
...
```bash
kubectl apply -k https://github.com/airlock/microgateway/deploy/charts/airlock-microgateway/crds/?ref=4.4.7 --server-side --force-conflicts
```
...
| engine.image.digest | string | `"sha256:44bfbf3982c4af2e37784ec973bbdb597c6f83c9a76054f17f585fe4f04fcc4c"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| engine.image.tag | string | `"4.4.7"` | Image tag to pull. |
...
| operator.image.digest | string | `"sha256:116a5ca9ca610355984b89996b1d313b6c8f1d047bf2e246f2b1e342512c3df1"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| operator.image.tag | string | `"4.4.7"` | Image tag to pull. |
...
| sessionAgent.image.digest | string | `"sha256:7fb0308619accc0dee3c876a8d14d09eada795da22dca30f77cb9a0c696ae75b"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| sessionAgent.image.tag | string | `"4.4.7"` | Image tag to pull. |
