...
| engine.image.digest | string | `"sha256:11704c15eb8f5932f9adc4d3abbeafac06409a8b0dcadfb109c2db8b685dcc75"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| engine.image.tag | string | `"4.2.10"` | Image tag to pull. |
...
| operator.image.digest | string | `"sha256:cff6ecc304a9adbdcf8acf456660836c34a5d8955e084c0422caaaf68bdeba44"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| operator.image.tag | string | `"4.2.10"` | Image tag to pull. |
