...
![Version: 4.2.7](https://img.shields.io/badge/Version-4.2.7-informational?style=flat-square) ![AppVersion: 4.2.7](https://img.shields.io/badge/AppVersion-4.2.7-informational?style=flat-square)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/4.2.7).__
...
| engine.image.digest | string | `"sha256:e43ad143279181c872a879932433e19b000b68906ffe6607de6cf20f9f3de65c"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| engine.image.tag | string | `"4.2.7"` | Image tag to pull. |
...
| operator.image.digest | string | `"sha256:524f37bee6a77a95fd91be78177af78614c22adae2d11650c7f4ffd79b664b26"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| operator.image.tag | string | `"4.2.7"` | Image tag to pull. |
