...
![Version: 4.4.8](https://img.shields.io/badge/Version-4.4.8-informational?style=flat-square) ![AppVersion: 4.4.8](https://img.shields.io/badge/AppVersion-4.4.8-informational?style=flat-square)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/4.4.8).__
...
1. Install CRDs and Operator.
   ...
   helm install airlock-microgateway -n airlock-microgateway-system oci://quay.io/airlockcharts/microgateway --version '4.4.8' --wait
   ```

2. (Recommended) You can verify the correctness of the installation with `helm test`.
   ```bash
   helm upgrade airlock-microgateway -n airlock-microgateway-system --set tests.enabled=true --reuse-values oci://quay.io/airlockcharts/microgateway --version '4.4.8'
   helm test airlock-microgateway -n airlock-microgateway-system --logs
   helm upgrade airlock-microgateway -n airlock-microgateway-system --set tests.enabled=false --reuse-values oci://quay.io/airlockcharts/microgateway --version '4.4.8'
   ```
...
```bash
kubectl apply -k https://github.com/airlock/microgateway/deploy/charts/airlock-microgateway/crds/?ref=4.4.8 --server-side --force-conflicts
```
...
| engine.image.digest | string | `"sha256:1e03e8f6404711080503703780d32178512a08a653381b97a0ff3a19aa0c09f1"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| engine.image.tag | string | `"4.4.8"` | Image tag to pull. |
...
| operator.image.digest | string | `"sha256:7913e0051b06de845d192004af15ddd6fdd0272fa6b233fb7e2133ceb1a04afb"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| operator.image.tag | string | `"4.4.8"` | Image tag to pull. |
...
| sessionAgent.image.digest | string | `"sha256:4a3941446bc763004ddd2519f95e25d5af74e5ffbe35fd5fc86149dc30ba5e0f"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| sessionAgent.image.tag | string | `"4.4.8"` | Image tag to pull. |
