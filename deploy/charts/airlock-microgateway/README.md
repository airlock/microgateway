...
1. Install CRDs and Operator.
   ...
   helm install airlock-microgateway -n airlock-microgateway-system oci://quay.io/airlockcharts/microgateway --version '4.5.8' --wait
   ```

2. (Recommended) You can verify the correctness of the installation with `helm test`.
   ```console
   helm upgrade airlock-microgateway -n airlock-microgateway-system --set tests.enabled=true --reuse-values oci://quay.io/airlockcharts/microgateway --version '4.5.8'
   helm test airlock-microgateway -n airlock-microgateway-system --logs
   helm upgrade airlock-microgateway -n airlock-microgateway-system --set tests.enabled=false --reuse-values oci://quay.io/airlockcharts/microgateway --version '4.5.8'
   ```
...
```console
kubectl apply -k https://github.com/airlock/microgateway/deploy/charts/airlock-microgateway/crds/?ref=4.5.8 --server-side --force-conflicts
```
...
| engine.image.digest | string | `"sha256:a9fdb773418570bc3ecdcc7e5b97120268e5abfc5c23cc6220112002b1d0cd2a"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| engine.image.tag | string | `"4.5.8"` | Image tag to pull. |
...
| operator.image.digest | string | `"sha256:e5c4dc9559957c123532a1cc9e2bdf157991a389da4e9fcb486165534cb9714f"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| operator.image.tag | string | `"4.5.8"` | Image tag to pull. |
...
| sessionAgent.image.digest | string | `"sha256:2177c8ba6802b7b94da496f6a21e9581368336d25c15263f783b8fd9fb34f4f3"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| sessionAgent.image.tag | string | `"4.5.8"` | Image tag to pull. |
