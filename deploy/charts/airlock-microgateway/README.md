...
[![Release](https://img.shields.io/badge/Release-v5.0.6-6bba62)](https://github.com/airlock/microgateway/releases/tag/5.0.6)
[![Gateway API Conformance](https://img.shields.io/badge/Gateway%20API%20Conformance-v1.5-6bba62?logo=kubernetes&logoColor=white)](https://github.com/kubernetes-sigs/gateway-api/blob/main/conformance/reports/v1.5/airlock-microgateway)
[![GitHub](https://img.shields.io/badge/GitHub-Published-6bba62?logo=github&logoColor=white)](https://github.com/airlock/microgateway/releases/tag/5.0.6)
...
__This Helm chart is part of Airlock Microgateway. See our [GitHub repo](https://github.com/airlock/microgateway/tree/5.0.6).__
...
```console
kubectl apply -k https://github.com/airlock/microgateway/deploy/charts/airlock-microgateway/crds/?ref=5.0.6 \
  --server-side \
  --force-conflicts
```
...
| config.engineImage.digest | string | `"sha256:558e49f6152dce0ad26acec6cfa2a9d7fd5139ea756b8adb8bd85cdd62c0ae89"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.engineImage.tag | string | `"5.0.6"` | Image tag to pull. |
...
| config.sessionAgentImage.digest | string | `"sha256:b9c97dbfd465c8156c20192c2d969bcaec0e3859709ff58ff37d0ea421b2ea37"` | SHA256 image digest to pull (in the format "sha256:a3051f42d3013813b05f7513bb86ed6a3209cb3003f1bb2f7b72df249aa544d3"). Overrides tag when specified. |
...
| config.sessionAgentImage.tag | string | `"5.0.6"` | Image tag to pull. |
...
| image.digest | string | `"sha256:cd9a75af072bb4c891ff8dfbf9e4cbefde20270ed5d1a931ec4a717433f0af7e"` | SHA256 image digest to pull (in the format "sha256:c79ee3f85862fb386e9dd62b901b607161d27807f512d7fbdece05e9ee3d7c63"). Overrides tag when specified. |
...
| image.tag | string | `"5.0.6"` | Image tag to pull. |
