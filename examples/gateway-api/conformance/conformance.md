...
1. Install CRDs and Operator.
   ...
   helm install -n airlock-microgateway-system airlock-microgateway oci://quay.io/airlockcharts/microgateway --wait --version '4.4.5' --set=operator.gatewayAPI.enabled=true
   ```
